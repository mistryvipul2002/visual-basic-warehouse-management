...
Begin VB.Form PurchaseReceipt 
   ...
   Begin VB.TextBox Text1 
      ...
      Width           =   735
   End
   Begin VB.TextBox TextSupplierName 
      Enabled         =   0   'False
      Height          =   285
      Left            =   8880
      TabIndex        =   19
      ...
      Width           =   4455
   End
   Begin VB.ComboBox ComboSupplierID 
      Height          =   315
      Left            =   5400
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "PurchaseReceipt.frx":0000
      Height          =   3975
      Left            =   480
      TabIndex        =   0
      Top             =   1680
   ...
   Begin VB.Label Label3 
      ...
      Width           =   1335
   End
   Begin VB.Label LabelSupplierId 
      Caption         =   "TIN Number"
      Height          =   255
      Left            =   4320
      TabIndex        =   18
   ...
   End
End
Attribute VB_Name = "PurchaseReceipt"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub Cancel_Click()
PurchaseForm.Adodc1.recordSet.Delete
Unload Me
End Sub
...
While Not Adodc1.recordSet.EOF
    If ComboProductCode.Text = Adodc1.recordSet.Fields("PRODUCTCODE") Then
        ...
        Adodc1.recordSet.Update Array("SRID", "PRODUCTCODE", "PRODUCTNAME", "QUANTITY", "SELLINGPRICE", "TOTAL"), Array(PRID.Text, ComboProductCode.Text, TextProductName.Text, newQty, TextSellingPrice.Text, newQty * TextSellingPrice.Text)
        Call updateTotal
        Exit Sub
    End If
    Adodc1.recordSet.MoveNext
Wend
Adodc1.recordSet.AddNew Array("SRID", "PRODUCTCODE", "PRODUCTNAME", "QUANTITY", "SELLINGPRICE", "TOTAL"), Array(PRID.Text, ComboProductCode.Text, TextProductName.Text, TextQuantity.Text, TextSellingPrice.Text, TextQuantity.Text * TextSellingPrice.Text)
Call updateTotal
End Sub

Private Sub ComboSUPPLIERID_Click()
Adodc4.recordSet.MoveFirst
While Not Adodc4.recordSet.EOF
    If ComboSupplierID.Text = Adodc4.recordSet.Fields("TINNO") Then
        TextSupplierName.Text = Adodc4.recordSet.Fields("SUPPLIERNAME")
    End If
...
'populate TINNO combo box
ComboSupplierID.Clear
Adodc4.recordSet.MoveFirst
While Not Adodc4.recordSet.EOF
    ComboSupplierID.AddItem Adodc4.recordSet.Fields("TINNO")
    Adodc4.recordSet.MoveNext
Wend
ComboSupplierID.ListIndex = 0
...
PurchaseForm.Adodc1.recordSet.Update "ORDERDATE", Now
PurchaseForm.Adodc1.recordSet.Update "TINNO", ComboSupplierID.Text
PurchaseForm.Adodc1.recordSet.Update "SUPPLIERName", TextSupplierName.Text
PurchaseForm.Adodc1.recordSet.Update "Discount", Val(TextDiscount.Text)
PurchaseForm.Adodc1.recordSet.Update "TotalAmt", Val(LabelTotal.Caption)

'Copy records from tempLines to purchaseOrderLines table
If Adodc1.recordSet.RecordCount <> 0 Then
    Adodc1.recordSet.MoveFirst
    While Not Adodc1.recordSet.EOF
        PurchaseForm.Adodc2.recordSet.AddNew Array("PRID", "PRODUCTCODE", "PRODUCTNAME", "QUANTITY", "SELLINGPRICE", "TOTAL"), Array(Adodc1.recordSet!SRID, Adodc1.recordSet!ProductCode, Adodc1.recordSet!ProductName, Adodc1.recordSet!Quantity, Adodc1.recordSet!SELLINGPRICE, Adodc1.recordSet!total)
        ...
        If Adodc2.recordSet.RecordCount <> 0 Then
            ...
            While Not Adodc2.recordSet.EOF
                If Adodc1.recordSet!ProductCode = Adodc2.recordSet.Fields("PRODUCTCODE") Then
                    Adodc2.recordSet.Update "PURCHASERATE", Adodc1.recordSet!SELLINGPRICE
                End If
                Adodc2.recordSet.MoveNext
            Wend
        End If
